...
/*!
     ...
     */
(function(g,h){var i="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";g.fn.imagesLoaded=function(q){var n=this,s=g.isFunction(g.Deferred)?g.Deferred():0,r=g.isFunction(s.notify),k=n.find("img").add(n.filter("img")),l=[],p=[],m=[];if(g.isPlainObject(q)){g.each(q,function(t,u){if(t==="callback"){q=u}else{if(s){s[t](u)}}})}function o(){var t=g(p),u=g(m);if(s){if(m.length){s.reject(k,t,u)}else{s.resolve(k)}}if(g.isFunction(q)){q.call(n,k,t,u)}}function j(t,u){if(t.src===i||g.inArray(t,l)!==-1){return}l.push(t);if(u){m.push(t)}else{p.push(t)}g.data(t,"imagesLoaded",{isBroken:u,src:t.src});if(r){s.notifyWith(g(t),[u,k,g(p),g(m)])}if(k.length===l.length){setTimeout(o);k.unbind(".imagesLoaded")}}if(!k.length){o()}else{k.bind("load.imagesLoaded error.imagesLoaded",function(t){j(t.target,t.type==="error")}).each(function(t,v){var w=v.src;var u=g.data(v,"imagesLoaded");if(u&&u.src===w){j(v,u.isBroken);return}if(v.complete&&v.naturalWidth!==h){j(v,v.naturalWidth===0||v.naturalHeight===0);return}if(v.readyState||v.complete){v.src=i;v.src=w}})}return s?s.promise(n):n}})(jQuery);var b=function(g){if(d.console){d.console.error(g)}};e.fn.masonry=function(h){if(typeof h==="string"){var g=Array.prototype.slice.call(arguments,1);this.each(function(){var i=e.data(this,"masonry");if(!i){b("cannot call methods on masonry prior to initialization; attempted to call method '"+h+"'");return}if(!e.isFunction(i[h])||h.charAt(0)==="_"){b("no such method '"+h+"' for masonry instance");return}i[h].apply(i,g)})}else{this.each(function(){var i=e.data(this,"masonry");if(i){i.option(h||{});i._init()}else{e.data(this,"masonry",new e.Mason(h,this))}})}return this}})(window,jQuery);(function(n,p,u){var w=n([]),s=n.resize=n.extend(n.resize,{}),o,l="setTimeout",m="resize",t=m+"-special-event",v="delay",r="throttleWindow";s[v]=250;s[r]=true;n.event.special[m]={setup:function(){if(!s[r]&&this[l]){return false}var a=n(this);w=w.add(a);n.data(this,t,{w:a.width(),h:a.height()});if(w.length===1){q()}},teardown:function(){if(!s[r]&&this[l]){return false}var a=n(this);w=w.not(a);a.removeData(t);if(!w.length){clearTimeout(o)}},add:function(b){if(!s[r]&&this[l]){return false}var c;function a(d,h,g){var f=n(this),e=n.data(this,t);e.w=h!==u?h:f.width();e.h=g!==u?g:f.height();c.apply(this,arguments)}if(n.isFunction(b)){c=b;return a}else{c=b.handler;b.handler=a}}};function q(){o=p[l](function(){w.each(function(){var d=n(this),a=d.width(),b=d.height(),c=n.data(this,t);if(a!==c.w||b!==c.h){d.trigger(m,[c.w=a,c.h=b])}});q()},s[v])}})(jQuery,this);
